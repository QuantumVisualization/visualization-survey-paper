\begin{figure}[htbp]
	...
	\begin{tikzpicture}[scale=0.85]
		...
		\begin{scope}[cm={1,0,0.5,0.8,(-1cm,0cm)}]
			\draw[thick] (0,0,0) -- (\ax,0,0) -- (\ax,\ay,0) -- (0,\ay,0) -- cycle;
			\draw[thick] (0,0,\az) -- (\ax,0,\az) -- (\ax,\ay,\az) -- (0,\ay,\az) -- cycle;
			\draw[thick] (0,0,0) -- (0,0,\az);
			\draw[thick] (\ax,0,0) -- (\ax,0,\az);
			\draw[thick] (\ax,\ay,0) -- (\ax,\ay,\az);
			\draw[thick] (0,\ay,0) -- (0,\ay,\az);
		\end{scope}
		...
		\node[draw, rounded corners, fill=yellow!20, text width=4.5cm, align=center] at (9,1.5) {
