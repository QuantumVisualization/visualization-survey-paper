\begin{figure}[htbp]
	...
	\begin{tikzpicture}[scale=1.0]
		...
		\node[draw, rounded corners, fill=yellow!20, text width=12cm, align=center, below=1cm] at (3.75,-0.8) {
			\textbf{Three-qubit entanglement polytope}: For three qubits, the state space splits into two disconnected SLOCC classes (GHZ and W). Each class forms a tetrahedron with 4 vertices (product states); interior points represent genuinely entangled states.
		};
	\end{tikzpicture}
