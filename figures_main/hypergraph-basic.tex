\begin{figure}[htbp]
	...
	\end{tikzpicture}
	\caption{Comparison of regular graphs and hypergraphs. In (a), each edge connects exactly two vertices, representing pairwise correlations. In (b), the dashed ellipse represents a hyperedge connecting three vertices, capturing genuine tripartite entanglement. Hyperedge connects $>2$ vertices and represents genuine multipartite correlations.}
